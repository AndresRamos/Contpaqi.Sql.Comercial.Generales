...
namespace Contpaqi.Sql.Comercial.Generales
{
    public class ComercialGeneralesDbContext : DbContext
    {
        ...
        public ComercialGeneralesDbContext(DbCompiledModel model) : base(model)
        {
        }

        public ComercialGeneralesDbContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }
        ...
        public ComercialGeneralesDbContext(DbConnection existingConnection, bool contextOwnsConnection) : base(existingConnection, contextOwnsConnection)
        {
        }
        ...
        public ComercialGeneralesDbContext(ObjectContext objectContext, bool dbContextOwnsObjectContext) : base(objectContext, dbContextOwnsObjectContext)
        {
        }
